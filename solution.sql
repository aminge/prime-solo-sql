...
-- 3. The bank is giving a new customer bonus! Update all records with an account balance 
...
-- 5. Get the username and account balance of the 3 users with the highest balances, sort 
-- highest to lowest balance. NOTE: Research LIMIT
SELECT username, account_balance FROM syntax_practice
ORDER BY account_balance DESC
LIMIT 3;
-- 6. Get the username and account balance of the 3 users with the lowest balances, sort 
